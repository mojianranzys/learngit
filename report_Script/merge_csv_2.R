...
for(i in seq(nrow(csv_df1))){
  for(j in seq(nrow(csv_df2))){
    if(csv_df1[i, 3] == csv_df2[j, 3] && csv_df1[i, 1] != csv_df2[j, 1] && csv_df1[i, 2] == csv_df2[j, 2] && csv_df1[i, 9] == csv_df2[j, 9] && csv_df1[i, 15] == csv_df2[j, 15] && ( csv_df1[i, 23] < csv_df2[j, 23])){
