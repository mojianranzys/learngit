...
cat(paste("###\n","ossutil cp -r oss://sz-hapres/haplox/hapyun/201912/pair_wes_IDT_no_facter_",
...
"###\n","echo ossutil cp -r oss://sz-hapres/haplox/hapyun/201912/pair_wes_IDT_no_facter_",
...
"perl /haplox/users/liaowt/Script/germline/germline_trans_v2.pl ", cancer_female, " ", cancer_female_trans, " \n", 
"perl /haplox/users/liaowt/Script/germline/germline_trans_v2.pl ", cancer_male, " ", cancer_male_trans, " \n", 
...
"###\n","Rscript /haplox/users/zhaoys/Script/id_information.R ",out,"/\n",sep = ""))
                 sink()
            }
        }
    }
