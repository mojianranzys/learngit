...
cat(paste("ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
 tumor_df[i, 1], "/tmp/MrBam_pair_node_16/mrbam/ --include *snv_MrBam.txt ", out,"/\n",
"ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
...
"ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
tumor_df[i, 1], "/tmp/factera_fusion_node_35/fusion/0001.sentieon-bwa-gencore-pileup-no-umi_cfdna_rgfactera.fusions.txt_output_4.factera.fusions.txt ",out,"/fusion/\n",
"ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
...
"ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
tumor_df[i, 1], "/tmp/virus_node_38/0001.virus_resulttxt_gdna_output_37.txt ", out, "/virus\n",
"echo ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
tumor_df[i, 1], "/tmp/sentieon-bwa-gencore-pileup-no-umi_node_3/ --include *gdna_rgbam_output_3.bam ./ >> /haplox/rawout/sort.txt\n",
"echo ossutil cp -r oss://sz-hapres/haplox/hapyun/201901/pair_mutant_pe_sentieon_gencore_IDT_16core64g_",
tumor_df[i, 1], "/tmp/sentieon-bwa-gencore-pileup-no-umi_node_4/ --include *cfdna_rgbam_output_4.bam ./ >> /haplox/rawout/sort.txt\n",
"#-------------------------------------------------------------------------------------------------\n",
...
"###\n","mv ", out,"/Msi/0001.Visual_msi_html_output_41.html ",out,"/Msi/", tumor_df[i,1], "_msi.html\n",
"###\n","mv ", out,"/Msi/0001.Visual_msi_json_output_41.json ",out,"/Msi/", tumor_df[i,1], "_msi.json\n",
"###\n","mv ", out,"/virus/0001.virus_resulttxt_cfdna_output_37.txt ", out, "/virus/",tumor_df[i,1],"_virus_result.txt\n",
"###\n","mv ", out,"/virus/0001.virus_resulttxt_gdna_output_37.txt ", out, "/virus/",tumor_df[i,"normal"],"_virus_result.txt\n",
