...
cat(paste("ossutil cp -r oss://sz-hapres/haplox/hapyun/201904/pair_IDT_HPCH_",
 tumor_df[i, 1], "/tmp/MrBam_pair_node_16/mrbam/ --include *snv_MrBam.txt ", out,"/\n",
"ossutil cp -r oss://sz-hapres/haplox/hapyun/201904/pair_IDT_HPCH_",
...
"echo ossutil cp -r oss://sz-hapres/haplox/hapyun/201904/pair_IDT_HPCH_",
